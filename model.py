...
class ConvNextLSTM(nn.Module):
    def __init__(self, pretrained=False, in_chans=3, class_num=1):
        ...
        self.lstm = LSTMMIL(num_features)#nn.LSTM(lstm_embed, lstm_embed//2, num_layers=1, dropout=drop, bidirectional=True, batch_first=True)
